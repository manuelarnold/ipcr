...
#### Load ipcr function ####
setwd("C:/Users/manue/OneDrive/Forschung/IPC Tutorial Paper/ipcr/R")

source("ipcr2.R")
source("ipcr3.R")
source("get_data.R")
source("check_ipcr_arguments.R")
source("bread.R")
source("summary.ipcr.R")
source("nobs.MxRAMModel.R")
source("estfun.MxRAMModel.R")
source("coef.ipcr.R")
source("iterated_ipcr.MxRAMModel.R")
source("iterated_ipcr.lavaan.R")
source("iterated_ipcr.R")
source("print.ipcr.R")
